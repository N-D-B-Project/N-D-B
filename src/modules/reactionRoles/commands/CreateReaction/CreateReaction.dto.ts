...
export class CreateReactionDTO {
	@ChannelOption({
		...
		name_localizations: localizationMapByKey(
			"ReactionRoles.create.options.channel.name",
		),
		description_localizations: localizationMapByKey(
			"ReactionRoles.create.options.channel.description",
		),
	...
	@StringOption({
		...
		name_localizations: localizationMapByKey(
			"ReactionRoles.create.options.message.name",
		),
		description_localizations: localizationMapByKey(
			"ReactionRoles.create.options.message.description",
		),
		required: true,
	})
	...
	@RoleOption({
		...
		name_localizations: localizationMapByKey(
			"ReactionRoles.create.options.role.name",
		),
		description_localizations: localizationMapByKey(
			"ReactionRoles.create.options.role.description",
		),
		required: true,
	})
	...
	@StringOption({
		...
		name_localizations: localizationMapByKey(
			"ReactionRoles.create.options.emoji.name",
		),
		description_localizations: localizationMapByKey(
			"ReactionRoles.create.options.emoji.description",
		),
		required: true,
	})
