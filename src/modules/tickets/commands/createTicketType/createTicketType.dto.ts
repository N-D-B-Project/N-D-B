...
export class CreateTicketTypeDTO {
	@StringOption({
		...
		description_localizations: localizationMapByKey(
			"Tickets.type.options.name.description",
		),
		autocomplete: false,
		required: true,
		min_length: 4,
	...
	@StringOption({
		...
		name_localizations: localizationMapByKey(
			"Tickets.type.options.description.name",
		),
		description: "The description of Ticket Type",
		description_localizations: localizationMapByKey(
			"Tickets.type.options.description.description",
		),
		autocomplete: false,
		required: true,
		min_length: 10,
	...
	@StringOption({
		name: "message",
		name_localizations: localizationMapByKey(
			"Tickets.type.options.message.name",
		),
		description: "The message that will be send when a ticket is opened",
		description_localizations: localizationMapByKey(
			"Tickets.type.options.message.description",
		),
		autocomplete: false,
		required: true,
	})
	...
	@StringOption({
		...
		description_localizations: localizationMapByKey(
			"Tickets.type.options.emoji.description",
		),
		autocomplete: false,
		required: true,
	})
